              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
					...
					$getgender= "SELECT Gender FROM users WHERE Username = '".$_SESSION['Username']."'";
					$querygender = mysqli_query($conn, $getgender);
					$gender = mysqli_fetch_array($querygender);
					...
					?>
					Welcome <?php if (isset($_SESSION['Username'])) { echo ' '.$_SESSION['Username']; } else{ header("location:login");}?>
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li>
                      <a href="javascript:;">
                        <span><i class="fa fa-plus pull-right"></i>Enroll Member</span>
                      </a>
                    </li>
